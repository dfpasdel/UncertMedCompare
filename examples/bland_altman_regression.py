...
def run_bland_altman_regression_example(weighting=None):
    #############################################
    #           Simulate some data              #
    #############################################
    mean_a = 30
    ...
    comparator = ContinuousComparator(reference_method_measurements=x,
                                      ...
                                      weighting=weighting,
                                      format_dimensional="{:0.4f}",
                                      format_non_dimensional="{:0.4f}")
...
if __name__ == '__main__':
    ...
    run_bland_altman_regression_example(weighting=None)

    # Inverse weighting: the regression lines are similar
    run_bland_altman_regression_example(weighting="inverse")
