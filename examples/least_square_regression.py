...
def run_least_square_regression_example(weighting=None):
    #############################################
    #           Simulate some data              #
    #############################################
    mean_a = 30
...
if __name__ == '__main__':
    ...
    run_least_square_regression_example(weighting=None)

    # Inverse weighting: the regression lines are similar
    run_least_square_regression_example(weighting="inverse")
